...
const questionSetting = () => ({
  ...
  "description": "Supported by PT. Pembangunan Perumahan  Tirta Riau (PPTR) ",
  "logoFit": "cover",
  "pages": [
    {
      "name": "page1",
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "description": "Pastikan dimulai dengan +62\nCth: +62 811 7607 775",
          "isRequired": true,
          "inputType": "tel"
        },
        {
        ...
        },
        {
          ...
          "description": "Salin titik koordinat lokasi pelanggan dari Google Maps"
        },
        {
          "type": "html",
          "name": "question1",
          "html": "\n<div class=\"sv-action  sd-btn \" style=\"padding: 2px; width: 130px; margin:0;\" onclick=\"checkLocation()\" >Refresh Lokasi</div>\n\n<div style=\"height:16px\"></div>\n\n<a href=\"{p_maps_}\" target=\"_blank\" >\n📍 Buka di Google Maps\n</a>\n<div style=\"height:6px\"></div>\n<iframe\n  width=\"100%\"\n  height=\"300\"\n  style=\"border:0; border-radius:8px\"\n  loading=\"lazy\"\n  referrerpolicy=\"no-referrer-when-downgrade\"\n  src=\"{p_maps_}&z=15&output=embed\">\n</iframe>"
        }
      ],
      "visibleIf": "{Target} = 'Non Pelanggan' or {Target} = 'Non Pelanggan (Tanpa Wawancara)'",
      "title": "Data {Target}"
    },
    {
      "name": "page7",
      "elements": [
        ...
        },
        {
          "type": "html",
          "name": "question7",
          "visibleIf": "{p_maps} notempty and {npa} notempty",
    ...
    },
    {
      ...
      "visibleIf": "{Target} <> 'Non Pelanggan (Tanpa Wawancara)'",
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "visibleIf": "{Kebutuhan Lainnya} = ['other']",
          "indent": 1,
          "title": "Air Galon (Bermerek)",
          "description": "Penggunaan dalam seminggu",
          "inputType": "number",
        ...
        },
        {
          ...
          "title": "Apakah Anda mengetahui bahwa sebagian besar air galon isi ulang menggunakan air tanah sebagai sumber air baku?",
          "labelTrue": "Ya",
          "labelFalse": "Tidak"
        },
        {
          ...
          "title": "Menurut Anda, seberapa aman kualitas air tanah untuk dikonsumsi jangka panjang oleh keluarga?",
          "choices": [
            "Sangat Tidak Aman ",
            "Tidak Aman ",
            "Aman ",
        ...
        },
        {
          ...
          "title": "Apakah anda mengetahui dampak negatif penggunaan air tanah ?",
          "isRequired": true,
          "labelTrue": "Sudah",
          "labelFalse": "Belum"
        },
        {
          "type": "expression",
          "name": "panel5",
          "visibleIf": "{Apakah anda mengetahui dampak negatif penggunaan air tanah ?} = false",
          "title": "Karena BELUM mengetahui dampak negatif penggunaan air tanah\n\nSilahkan dijelaskan dampak nya ya 🤗\n\n"
        },
        {
          "type": "radiogroup",
          "name": "Apakah boleh disampaikan kisaran total pendapatan rumah tangga per bulan ?",
          "title": "Apakah boleh disampaikan kisaran total pendapatan rumah tangga per bulan ?",
          "isRequired": true,
          "choices": [
            "< Rp3 juta",
            "Rp3 – 6 juta",
        ...
        },
        {
          ...
          "title": "Apakah tagihan air PDAM di kisaran Rp {harga_min} – Rp {harga_max} per bulan sebanding dengan manfaat yang diperoleh dibandingkan penggunaan air tanah ?",
          "isRequired": true,
          "choices": [
            "Ya",
            "Tidak",
        ...
        },
        {
          ...
          "title": "Bagaimana pendapat Anda tentang tarif air PDAM saat ini jika dibandingkan dengan pengeluaran air galon, listrik pompa, dan risiko penggunaan air tanah ?",
          "isRequired": true,
          "choices": [
            "Lebih hemat",
            "Kurang lebih sama",
        ...
        },
        {
          ...
          "title": "3. Apakah anda berencana menggunakan air pdam untuk ?",
          "choices": [
            "Cuci kendaraan",
            "Menyiram tanaman"
          ],
        ...
        },
        {
          ...
          "title": "Apa yang Anda harapkan agar air PDAM bisa menjadi sumber air utama keluarga?",
      ...
      "elements": [
        {
          ...
          "visibleIf": "{Target} = 'Pelanggan'",
          "title": "Treatment Program 3 Bulan Gratis Air (maks. pemakaian 15 m³) bila pemakaian di atas 15 m3, menjadi tanggungan pelanggan. bagi yang belum, akan di bantu menyambungkan ke instalasi rumah, pelanggan hanya menyediakan materialnya saja --- Bila ada program seperti ini ? Apakah berminat mengikutinya",
          "isRequired": true,
          "choices": [
            "Berminat",
            "Ragu-ragu",
      ...
      "elements": [
        {
          ...
          "maxFiles": 3,
          "sourceType": "camera",
          "fileOrPhotoPlaceholder": "Pilih button dibawah untuk mengambil foto",
...
export default function Dashboard() {
  const quesions = useMemo(questionSetting, []);
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Survey Perumdam" />
      <FormSurvey value={quesions} />
...
export const FormSurvey = ({ value }: any) => {
  const { form, model } = useSurveyViewer({
    json: value,
    lazyload: [
    ...
    onChange: (sender, options) => {
      if (options.name === 'npa') {
        ...
        if (selected) {
          ...
          setLocationValues(sender, selected);
        }
      }
        ...
        if (next) {
          async function run() {
            try {
              ...
              if (coord) {
                setLocationValues(sender, coord, '_');
              }
  ...
  // useCheckLocation(model);

  return form;
};

function useCheckLocation(model?: SurveyModel) {
  useEffect(() => {
    if (model) {
      async function run() {
        try {
...
function getGeolocation() {
  return new Promise((resolve) => {
    navigator.geolocation.getCurrentPosition(
      ...
      {
        enableHighAccuracy: false, // ⬅️ penting
        timeout: 20000,
        maximumAge: 60000,
      },
    );
...
function setLocationValues(
  ...
  if (model) {
    model.setValue('p_lat' + name, lat);
    model.setValue('p_long' + name, long);
    model.setValue(
      'p_maps' + name,
