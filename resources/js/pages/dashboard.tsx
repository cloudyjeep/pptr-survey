      ...
      elements: [
        {
          ...
          isRequired: true,
          choices: ['Tersambung Instalasi', 'Belum Tersambung Instalasi'],
        },
        {
          type: 'text',
          name: 'Nama Responden',
        ...
        },
        {
          ...
          isRequired: true,
          choices: ['Suami', 'Istri', 'Anak', 'Saudara', 'Orang Tua', 'ART'],
        },
        {
          type: 'radiogroup',
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          choices: ['Kualitas air', 'Kontinuitas aliran', 'Penanganan keluhan'],
          showOtherItem: true,
          otherPlaceholder: 'Sebutkan…',
          noneText: 'Tidak Ingin Menjawab',
          otherText: 'Lainnya',
  ...
  const { form, model } = useSurveyViewer({
    ...
    onChange: (sender, options) => {
      ...
      if (options.name == 'Target') {
        if (options.value == 'Non Pelanggan') {
          async function run() {
            try {
